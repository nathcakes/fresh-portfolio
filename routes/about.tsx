    ...
    return (
        <Container>
            ...
            <div class={"max-w-screen-2xl justify-center space-y-10 grid grid-cols-1 mx-auto mt-20 pt-20 px-2 gap-0.5 md:grid-cols-2 lg:grid-cols-3"}>
                ...
                <div class={"md:order-7 lg:order-7"}><Card title={"Volunteer Work"} description={"I am passionate about helping my local community and especially inspiring the next generation of programmers. I volunteer at the Curtin branch of Coder Dojo to teach & mentor high school students in programming. I also provided free tutoring in Computer Science classes for first-year students at Curtin."}  /></div>
            </div>
        </Container>
    );
}